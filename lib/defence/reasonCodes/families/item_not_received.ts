...
export const item_not_received: ReasonCodeFamily = {
  ...
  overlayPromptBody: [
    ...
    "NEVER NEGATE DELIVERY in any form: no 'un-' prefix on the word delivered, no 'not' in front of it, and never state the case as a denial of non-receipt or loss. For a shipment in transit, state only what the carrier's record shows and when (6a8848-dd #102193).",
