...
const T = {
  fraudIntel: {
    ...
    segmentFraudProfileTitle: {
      de: "Betrugsrisikoprofil · Letzte 30 Tage",
      es: "Perfil de riesgo de fraude · Últimos 30 días",
      fr: "Profil de risque de fraude · 30 derniers jours",
      pt: "Perfil de risco de fraude · Últimos 30 dias",
      sv: "Bedrägeririskprofil · Senaste 30 dagarna",
    },
    segmentFraudProfileSubtitle: {
      de: "Shopifys Klassifizierungs-Signale und die daraus resultierenden Streitfälle",
      es: "Las señales de clasificación de Shopify y las disputas que siguieron",
      fr: "Les signaux de classification de Shopify et les litiges qui en ont résulté",
      pt: "Sinais de classificação do Shopify e as disputas que se seguiram",
      sv: "Shopifys klassificeringssignaler och tvisterna som följde",
    },
    segmentVerificationTitle: {
      de: "Zahlungsverifizierung · Letzte 30 Tage",
      es: "Verificación de pago · Últimos 30 días",
      fr: "Vérification du paiement · 30 derniers jours",
      pt: "Verificação de pagamento · Últimos 30 dias",
      sv: "Betalningsverifiering · Senaste 30 dagarna",
    },
    segmentVerificationSubtitle: {
      de: "Karten-Authentifizierung und Shopify-Protect-Übernahme",
      es: "Autenticación a nivel de tarjeta y cobertura de Shopify Protect",
      fr: "Authentification de la carte et couverture par Shopify Protect",
      pt: "Autenticação no nível do cartão e cobertura do Shopify Protect",
      sv: "Kortnivå-autentisering och Shopify Protect-täckning",
    },
    segmentDeliveryTitle: {
      de: "Liefer-Operationen · Letzte 30 Tage",
      es: "Operaciones de entrega · Últimos 30 días",
      fr: "Opérations de livraison · 30 derniers jours",
      pt: "Operações de entrega · Últimos 30 dias",
      sv: "Leveransverksamhet · Senaste 30 dagarna",
    },
    segmentDeliverySubtitle: {
      de: "Versandbestätigung, Unterschriftserfassung und Bearbeitungszeit",
      es: "Confirmación del transportista, captura de firma y tiempos de cumplimiento",
      fr: "Confirmation du transporteur, capture de signature et délai d'expédition",
      pt: "Confirmação da transportadora, captura de assinatura e prazos de atendimento",
      sv: "Bekräftelse från transportör, signaturhämtning och uppfyllelse­tid",
    },
    ordersWordTotal: {
