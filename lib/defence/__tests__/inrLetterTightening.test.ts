...
describe("opening line — the carrier record, then the dispute date", () => {
  it("states carrier, order, tracking, delivery date and the later dispute date", () => {
    expect(opening([stallion], "2026-09-19T02:33:38Z")).toBe(
      "Stallion Express recorded the shipment for order #352543 (tracking 260702441A) as delivered on 6 July 2026; the dispute was opened on 19 September 2026.",
    );
  });

  it("leaves the dispute date out when delivery came after it", () => {
    expect(opening([stallion], "2026-07-01T00:00:00Z")).toBe(
      "Stallion Express recorded the shipment for order #352543 (tracking 260702441A) as delivered on 6 July 2026.",
    );
  });
  ...
  it("on a multi-parcel order names the delivered parcel as 'a shipment', never the order", () => {
    ...
    expect(opening([multi], "2026-09-19T02:33:38Z")).toBe(
      "GOFO recorded a shipment for order #352543 (tracking YT2640221437435982) as delivered on 24 September 2026.",
    );
  });
