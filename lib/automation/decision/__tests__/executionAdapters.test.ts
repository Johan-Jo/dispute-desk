 ...
 *
 * A deadline relaxes NOTHING. Each of the five conjunctive conditions is
 * flipped independently below and each one on its own stops the filing.
 */
...
describe("deadline trigger — P-6, five conjunctive conditions", () => {
  const base = {
    decision: decision({ action: "hold_for_deadline" }),
