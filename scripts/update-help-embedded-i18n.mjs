...
const TRANSLATIONS = {
  "en-US": {
    ui: {
      ...
      contactSupport: "Need more help? Contact support@disputedesk.com",
  ...
  "de-DE": {
    ui: {
      ...
      contactSupport: "Weitere Hilfe? Kontaktiere uns: support@disputedesk.com",
  ...
  "es-ES": {
    ui: {
      ...
      contactSupport: "¿Necesitas más ayuda? Contacta: support@disputedesk.com",
  ...
  "fr-FR": {
    ui: {
      ...
      contactSupport: "Besoin d'aide ? Contactez : support@disputedesk.com",
  ...
  "pt-BR": {
    ui: {
      ...
      contactSupport: "Precisa de mais ajuda? Entre em contato: support@disputedesk.com",
  ...
  "sv-SE": {
    ui: {
      ...
      contactSupport: "Behöver du mer hjälp? Kontakta: support@disputedesk.com",
