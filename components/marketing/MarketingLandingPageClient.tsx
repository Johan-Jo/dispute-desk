          ...
          >
            ...
            <div className="flex items-start justify-between my-5 px-2.5 py-4 bg-[#F6F9FD] border border-[#EAF0F8] rounded-xl">
              <div className="flex-1 flex flex-col items-center gap-2 text-center">
                ...
                <span className="text-xs font-semibold text-[#1F2937] leading-[1.35]">{t("pricing.installStepConnect")}</span>
              </div>
              ...
              <div className="flex-1 flex flex-col items-center gap-2 text-center">
                ...
                <span className="text-xs font-semibold text-[#1F2937] leading-[1.35]">{t("pricing.installStepAnalysis")}</span>
              </div>
              <ArrowRight className="w-[15px] h-[15px] text-[#C2CCD9] mt-[11px]" strokeWidth={2.5} />
              <div className="flex-1 flex flex-col items-center gap-2 text-center">
                <div className="w-9 h-9 rounded-[10px] bg-[#E7F0FE] text-[#1F6FEB] flex items-center justify-center">
                ...
                <span className="text-xs font-semibold text-[#1F2937] leading-[1.35]">{t("pricing.installStepProtected")}</span>
              </div>
            </div>
