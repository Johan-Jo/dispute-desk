...
import type { MerchantAssessmentProjectionWithReason } from "@/lib/evidence/model/merchantProjection";
import {
  deadlineFilingCopy,
...
export interface WorkspaceAssessmentPayload {
  ...
  assessment: MerchantAssessmentProjectionWithReason;
...
export function emptyWorkspaceAssessment(
  disputeId: string,
  reason: "snapshot_absent" | "input_hash_mismatch" | "policy_version_superseded" =
    "snapshot_absent",
