...
export async function GET(req: NextRequest) {
  ...
  if (inIframe || fromEmbedded || refererIsOurApp) {
    ...
    const redirectScript = host
      ? `(function(){var u=${JSON.stringify(safeAuthUrl)};var t=0;var i=setInterval(function(){if(typeof window.shopify!=='undefined'){clearInterval(i);open(u,'_top');}else if(++t>40){clearInterval(i);open(u,'_top');}},100);})();`
      : "";
